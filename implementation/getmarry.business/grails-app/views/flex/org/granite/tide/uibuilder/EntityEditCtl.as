...
package org.granite.tide.uibuilder {
    ...
    public class EntityEditCtl {
        ...
        public function save(event:SaveEntityEvent):void {
            ...
            if (create)
                context["com.apolloti.getmarry.controller."+_entityName + "Controller"].persist(context, params, saveResult, saveFault);
            else
                context["com.apolloti.getmarry.controller."+_entityName + "Controller"].merge(context, params, saveResult, saveFault);
        }
        ...
        private function removeConfirm(event:CloseEvent):void {
            if (event.detail == Alert.YES)
                context["com.apolloti.getmarry.controller."+_entityName + "Controller"].remove(context, {id: context[_entityName + 'Instance'].id}, removeResult);
        }
