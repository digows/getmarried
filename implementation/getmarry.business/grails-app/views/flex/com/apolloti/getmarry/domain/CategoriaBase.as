 ...
 * THE GENERATOR. INSTEAD, EDIT THE INHERITED CLASS (Categoria.as).
 */
...
package com.apolloti.getmarry.domain {
    ...
    [Managed]
    public class CategoriaBase implements IExternalizable, IUID {
        ...
        meta function isInitialized(name:String = null):Boolean {
            ...
            return (
                (!(property is Categoria) || (property as Categoria).meta::isInitialized()) &&
...
*/
        ...
        public function meta_merge(em:IEntityManager, obj:*):void {
            var src:CategoriaBase = CategoriaBase(obj);
